...
export = {
    groupPriorities: [
        ...
        {name: 'Transaction',
            fields: ['tr_id', 'tr_af', 'tr_tt', 'tr_tx', 'tr_sh', 'tr_ci', 'tr_st', 'tr_co', 'tr_cu', 'ti_id', 'ti_sk', 'ti_na', 'ti_nm', 'ti_ca', 'ti_pr', 'ti_qu', 'ti_cu']},
        {name: 'Ad',
    ...
    paramMap: {
        ...
        e: {name: 'Event Type', type: 'emap', values: {pv: 'Pageview', pp: 'Page Ping', ue: 'Self-Describing Event', tr: 'Transaction', ti: 'Transaction Item', se: 'Structured Event'}},

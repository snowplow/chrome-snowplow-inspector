...
The universal debugger uses a link:https://ngrok.com/[Ngrok] tunnel in order to process events. Ngrok provides a HTTP endpoint that we can use as the temporary collector endpoint.

To start the tunnel ensure you have downloaded ngrok locally and create a new tunnel with:
